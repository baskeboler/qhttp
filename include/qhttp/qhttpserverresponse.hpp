...
namespace server {
///////////////////////////////////////////////////////////////////////////////
/** The QHttpResponse class handles sending data back to the client as a
 * response to a request.  @sa QHttpConnection
 */
...
public:
     ...
     * default value is ESTATUS_BAD_REQUEST.  @sa write()
     */
