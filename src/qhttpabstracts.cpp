...
static struct {
  int code;
  const char *message;
} g_status_codes[]{QHTTP_STATUS_MAP(PATCH_STATUS_CODES)};
...
// qhttp::client::QHttpClientPrivate::~QHttpClientPrivate() {}
// qhttp::client::QHttpRequestPrivate::~QHttpRequestPrivate() {}
// qhttp::client::QHttpResponsePrivate::~QHttpResponsePrivate() {}
// qhttp::server::QHttpServerPrivate::~QHttpServerPrivate() {}
// qhttp::server::QHttpRequestPrivate::~QHttpRequestPrivate() {}
// qhttp::server::QHttpResponsePrivate::~QHttpResponsePrivate() {}
// qhttp::server::QHttpConnectionPrivate::~QHttpConnectionPrivate() {}
///////////////////////////////////////////////////////////////////////////////

const char *Stringify::toString(TStatusCode code) {
...
const char *Stringify::toString(THttpMethod method) {
  return http_method_str(static_cast<http_method>(method));
}

QString Stringify::toStringV4(const QHostAddress &addr) {
